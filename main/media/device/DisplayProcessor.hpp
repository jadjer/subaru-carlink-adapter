...
public:
  DisplayProcessor() noexcept;
  ~DisplayProcessor() noexcept override = default;

public:
  [[nodiscard]] auto processMessage(iebus::Message const& message) -> iebus::Device::MessageList override;
